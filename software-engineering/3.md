...
# Spiral Model
- classical modells do not deal with the uncertainty in the requirements
- a lot of risk assessment and analysis form a part of the software development process
...
- each iteration in the spiral begins with identification of objectives, alternatives, and constraints for that phase of the project
